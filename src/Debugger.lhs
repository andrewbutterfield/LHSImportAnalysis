...
Now, versions of \texttt{pdbg} where a rendering function is supplied, 
rather than using \texttt{show}, and where the newline is optional.
\begin{code}
...
We have a debugging version of \texttt{unlines'} here.
\begin{code}
unlns' [] = ""
unlns' [s] = s
unlns' (s:ss) = s ++ '\n':unlns' ss
